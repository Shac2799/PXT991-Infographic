...
def main():
    ...
    Days = st.slider("Duration [Days]", min_value = 0.0, max_value = 1000.0, step = 5.0,value = 0.0)
    ...
    init_x2 = st.slider("Initial x coordinate of object 2 (blue)", min_value = -5.0, max_value = 5.0, step = 0.5,value = 0.0)
    init_y2 = st.slider("Initial y coordinate of object 2 (blue)", min_value = -5.0, max_value = 5.0, step = 0.5,value = 1.0) 

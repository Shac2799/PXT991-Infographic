...
def main():
    ...
    init_x1 = st.slider("Initial x coordinate of object 1 (red)", min_value = -5.0, max_value = 5.0, step = 0.5)
    init_y1 = st.slider("Initial y coordinate of object 1 (red)", min_value = -5.0, max_value = 5.0, step = 0.5) 
    Earth = Object(init_x1,init_y1,init_vel,90,5.97e24,Days) 
    sun = Body(696.343e6,mass_body,0,0)
    init_x2 = st.slider("Initial x coordinate of object 2 (blue)", min_value = -5.0, max_value = 5.0, step = 0.5)
    init_y2 = st.slider("Initial y coordinate of object 2 (blue)", min_value = -5.0, max_value = 5.0, step = 0.5) 
